...
2. [Framework Report](framework-report.md)
3. [Assessment Questionnaires](assessment-questionnaires.md)
4. [Implementation Templates](implementation-templates.md)
5. [Regulatory Reference Guide](regulatory-reference.md)
6. [Case Studies](case-studies.md)
8. [Implementation Decision Tree](decision-tree.md)
9. [Implementation Timeline](implementation-timeline.md)
10. [Field Data Collection Template](field-data-template.md)

## Getting Started

We recommend beginning with the [Executive Summary](executive-summary.md) to understand the AECDMF approach and benefits. Then proceed to the [Framework Report](framework-report.md) for a comprehensive overview of the framework structure and methodology. The [Assessment Questionnaires](assessment-questionnaires.md) will help you conduct your initial maturity evaluation.
...
Website: https://github.com/andbarker/STREAM/issues 
